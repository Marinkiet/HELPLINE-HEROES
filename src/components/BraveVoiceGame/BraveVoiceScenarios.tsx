        ...
        <div className="bg-white rounded-3xl p-8 max-w-2xl w-full shadow-2xl text-center">
          <div className="mb-6">
            ...
            <h1 className="text-4xl font-black text-gray-800 mb-4">
              Amazing! You Found Your Brave Voice! 🎉
            </h1>
          ...
          <button
            onClick={onComplete}
            className="bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white font-black py-4 px-8 rounded-2xl shadow-lg transform hover:scale-105 transition-all duration-200 text-xl"
          >
          ...
          {!showFeedback ? (
            ...
            <>
              ...
              <div className="flex justify-center space-x-4">
                ...
                <button
                  onClick={handleNext}
                  className="bg-gradient-to-r from-indigo-500 to-purple-500 hover:from-indigo-600 hover:to-purple-600 text-white font-bold py-3 px-6 rounded-xl shadow-lg transform hover:scale-105 transition-all duration-200"
                >
                  {currentScenario < scenarios.length - 1 ? 'Next Scenario' : 'Finish Training'}
                </button>
              </div>
            </>
          )}
