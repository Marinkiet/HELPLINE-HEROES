...
import { Play, Shield, CheckCircle, Trophy } from 'lucide-react';
...
export function BullyingResponseGameContainer({ onClose }: BullyingResponseGameContainerProps) {
  ...
  const handleNext = () => {
    if (currentQ < questions.length - 1) {
      ...
      trackGameComplete('10', 'Bullying Response Team', score);
      setStage('complete');
    }
  };
  ...
  if (stage === 'intro') {
    return (
      <div className="fixed inset-0 bg-gradient-to-br from-orange-400 via-red-400 to-red-500 flex items-center justify-center p-4 z-50">
        <div className="max-w-2xl w-full bg-white rounded-3xl shadow-2xl p-8 md:p-12">
          <div className="text-center">
            <div className="mb-6 flex justify-center">
              <div className="bg-gradient-to-r from-orange-500 to-red-500 p-6 rounded-full">
                <Shield className="w-16 h-16 text-white" />
              </div>
            </div>
            <h1 className="text-4xl font-black text-gray-900 mb-4">Bullying Response Team</h1>
            <p className="text-xl text-gray-700 mb-8">
              Learn how to stay safe online and recognize inappropriate behavior on the internet.
            </p>
            <button
              onClick={() => setStage('quiz')}
              className="bg-gradient-to-r from-orange-600 to-red-600 hover:from-blue-700 hover:to-cyan-700 text-white px-12 py-6 rounded-full text-xl font-bold shadow-xl transform hover:scale-105 active:scale-95 transition-all flex items-center justify-center mx-auto"
            >
    ...
    return (
      <div className="fixed inset-0 bg-gradient-to-br from-orange-400 via-red-400 to-red-500 flex items-center justify-center p-4 z-50">
        <div className="max-w-2xl w-full bg-white rounded-3xl shadow-2xl p-8 md:p-12 text-center">
          ...
          <button
            onClick={onClose}
            className="bg-gradient-to-r from-orange-600 to-red-600 text-white px-12 py-4 rounded-full text-xl font-bold shadow-lg transform hover:scale-105 active:scale-95 transition-all"
          >
            Continue
          </button>
        </div>
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-orange-400 via-red-400 to-red-500 flex items-center justify-center p-4 z-50 overflow-auto">
      <div className="max-w-3xl w-full bg-white rounded-3xl shadow-2xl p-8 md:p-12 my-8">
        ...
        <div className="bg-gradient-to-r from-orange-500 to-red-500 p-6 rounded-2xl mb-8">
            ...
            <button
              ...
              className={`w-full p-4 rounded-xl font-semibold text-left transition-all ${
                selectedAnswer === index
                  ...
                  : 'bg-gray-50 border-2 border-gray-200 hover:border-orange-400'
              }`}
            >
              {option}
        ...
        {showFeedback && (
          <>
            ...
            <button
              onClick={handleNext}
              className="w-full bg-gradient-to-r from-orange-600 to-red-600 text-white px-8 py-4 rounded-full font-bold shadow-lg transform hover:scale-105 active:scale-95 transition-all"
            >
