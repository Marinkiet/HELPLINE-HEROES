...
import { ThumbsUp, ThumbsDown, RotateCcw, Trophy, Home, ArrowLeft } from 'lucide-react';
...
interface FeelingSafeAtHomeScenariosProps {
  onComplete: () => void;
}

export function FeelingSafeAtHomeScenarios({ onComplete }: FeelingSafeAtHomeScenariosProps) {
  ...
  const scenarios = feelingSafeAtHomeContent.scenarios;
  ...
  const generateFeedbackAudio = async () => {
    try {
      ...
      let text = feelingSafeAtHomeContent.feedback[feedbackKey][selectedLanguage];
        ...
        <div className="bg-white rounded-3xl p-8 max-w-2xl w-full shadow-2xl text-center">
          <div className="mb-6">
            ...
            <h1 className="text-4xl font-black text-gray-800 mb-4">
              Amazing! You Know About Safe Homes! 🎉
            </h1>
            ...
            <div className="bg-green-100 border-l-4 border-green-400 p-4 rounded-r-xl">
              <p className="text-lg text-green-800">
                {feelingSafeAtHomeContent.completion[selectedLanguage]}
              </p>
            </div>
          </div>
          ...
          {!showFeedback ? (
            ...
            <>
              ...
              <div className="text-center mb-8">
                <div className={`${lastAnswerCorrect ? 'bg-green-50 border-green-400' : 'bg-red-50 border-red-400'} border-l-4 p-6 rounded-r-xl mb-6`}>
                  ...
                  <p className="text-xl text-gray-700 leading-relaxed mb-4">
                    {feelingSafeAtHomeContent.feedback[lastAnswerCorrect ? 'correct' : 'incorrect'][selectedLanguage]}
                  </p>
                  {lastAnswerCorrect && (
              ...
              <div className="flex justify-center space-x-4">
                ...
                <button
                  onClick={handleNext}
                  className="bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white font-bold py-3 px-6 rounded-xl shadow-lg transform hover:scale-105 transition-all duration-200"
                >
                  {currentScenario < scenarios.length - 1 ? 'Next Scenario' : 'Finish Learning'}
                </button>
              </div>
            </>
          )}
