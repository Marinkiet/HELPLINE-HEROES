...
export function FeelingSafeGameContainer({ onClose }: FeelingSafeGameContainerProps) {
  ...
  const handleNext = () => {
    if (currentQ < questions.length - 1) {
      ...
      trackGameComplete('9', 'Feeling Safe at Home', score);
      setStage('complete');
    }
  };
  ...
  if (stage === 'intro') {
    return (
      <div className="fixed inset-0 bg-gradient-to-br from-purple-400 via-indigo-400 to-blue-500 flex items-center justify-center p-4 z-50">
        <div className="max-w-2xl w-full bg-white rounded-3xl shadow-2xl p-8 md:p-12">
          <div className="text-center">
            <div className="mb-6 flex justify-center">
              <div className="bg-gradient-to-r from-purple-500 to-indigo-500 p-6 rounded-full">
                <Home className="w-16 h-16 text-white" />
              </div>
            </div>
            <h1 className="text-4xl font-black text-gray-900 mb-4">Feeling Safe at Home</h1>
            <p className="text-xl text-gray-700 mb-8">
              Learn how to stay safe online and recognize inappropriate behavior on the internet.
            </p>
            <button
              onClick={() => setStage('quiz')}
              className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-blue-700 hover:to-cyan-700 text-white px-12 py-6 rounded-full text-xl font-bold shadow-xl transform hover:scale-105 active:scale-95 transition-all flex items-center justify-center mx-auto"
            >
    ...
    return (
      <div className="fixed inset-0 bg-gradient-to-br from-purple-400 via-indigo-400 to-blue-500 flex items-center justify-center p-4 z-50">
        <div className="max-w-2xl w-full bg-white rounded-3xl shadow-2xl p-8 md:p-12 text-center">
          ...
          <button
            onClick={onClose}
            className="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-12 py-4 rounded-full text-xl font-bold shadow-lg transform hover:scale-105 active:scale-95 transition-all"
          >
            Continue
          </button>
        </div>
  ...
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-purple-400 via-indigo-400 to-blue-500 flex items-center justify-center p-4 z-50 overflow-auto">
      <div className="max-w-3xl w-full bg-white rounded-3xl shadow-2xl p-8 md:p-12 my-8">
        ...
        <div className="bg-gradient-to-r from-purple-500 to-indigo-500 p-6 rounded-2xl mb-8">
        ...
        {showFeedback && (
          <>
            ...
            <button
              onClick={handleNext}
              className="w-full bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-8 py-4 rounded-full font-bold shadow-lg transform hover:scale-105 active:scale-95 transition-all"
            >
