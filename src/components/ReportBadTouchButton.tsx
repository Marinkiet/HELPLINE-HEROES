          ...
          <div className="bg-white rounded-3xl p-6 max-w-sm w-full shadow-2xl transform animate-bounce-in">
            ...
            <div className="text-center mb-6">
              ...
              <p className="text-base text-gray-700 leading-relaxed mb-4">
                If someone touched you in a way that made you feel scared or uncomfortable like a bad touch, you can call <strong>116</strong> to talk to a kind adult who will help you.
              </p>
            </div>
