...
import { ThumbsUp, ThumbsDown, RotateCcw, Trophy, ArrowLeft } from 'lucide-react';
...
export function TouchScenarioGame({ onComplete }: TouchScenarioGameProps) {
  ...
  const handleAnswer = (answer: 'good' | 'bad') => {
    ...
    const isFirstAttempt = firstAttempts[currentScenario] !== false; // Default to true if not set
