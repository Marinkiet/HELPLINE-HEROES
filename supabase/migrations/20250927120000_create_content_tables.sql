...
-- Seed initial data
-- Age Groups
INSERT INTO age_groups (name, description, image_url, age_range) VALUES
('{"en": "Little Heroes", "af": "Klein Helde", "zu": "Amaqhawe Amancane", "xh": "Amaqhawe Amancinci", "st": "Liqhawe tse Nyane", "tn": "Diqhakga tse Dinnye", "ts": "Tiqhakga ta le Hansi", "ve": "Magwala Maduku", "nr": "Amaqhawe Amancane", "nso": "Magwala a Mannye"}', '{"en": "Fun activities for young children", "af": "Prettige aktiwiteite vir jong kinders", "zu": "Imisebenzi ejabulisayo yezingane ezincane", "xh": "Imisebenzi emnandi yabantwana abancinci", "st": "Mesebetsi e monate ea bana ba banyane", "tn": "Ditiro tse di monate tsa bana ba bannye", "ts": "Mintirho ya ntsakiso ya vana va vatsongo", "ve": "Mishumo ya u tsakisa ya vhana vhaduku", "nr": "Imisebenzi ejabulisayo yezingane ezincane", "nso": "Mešomo ye mebotse ya bana ba bannye"}', './assets/star.jpg', '6-8'),
('{"en": "Smart Explorers", "af": "Slim Ontdekkers", "zu": "Abaphenyi Abahlakaniphile", "xh": "Abaphandi Abahlakaniphileyo", "st": "Bafuputsi ba Bohlale", "tn": "Batlhatlhobi ba Botlhale", "ts": "Vafuputsi va Vutlhari", "ve": "Vhafuputsi vha Vhutshilo", "nr": "Abaphenyi Abahlakaniphile", "nso": "Bafuputši ba Bohlale"}', '{"en": "Learning adventures for school-age kids", "af": "Leeravonture vir skoolkinders", "zu": "Izigigaba zokufunda zezingane zasesikoleni", "xh": "Uhambo lokufunda lwabantwana abasesikolweni", "st": "Dipalangwang tsa ho ithuta tsa bana ba sekolo", "tn": "Dipalangwa tsa go ithuta tsa bana ba sekolo", "ts": "Maendzo ya ku dyondza ya vana va xikolo", "ve": "Zwiendedzo zwa u guda zwa vhana vha tshikolo", "nr": "Izigigaba zokufunda zezingane zasesikoleni", "nso": "Dipalangwa tša go ithuta tša bana ba sekolo"}', './assets/book.jpg', '9-11'),
